        ...
        <div class="container-fluid d-flex align-items-center" style="min-height: 100vh; margin: 0; padding-left: 0; padding-top: 0;">
            <div class="row no-gutters w-100">
                ...
                <div class="col-md-8 d-flex flex-column justify-content-center">
                    ...
                    <div class="row text-center">
                        <div class="col-md-3">
                            <img src="/assets/learning 1.jpg" alt="Lembar Kerja" class="img-fluid d-block w-100 carousel-img" style="margin-bottom: 10px;">
                        ...
                        <div class="col-md-3">
                            <img src="/assets/learning 2.png" alt="Lembar Kerja Mandiri" class="img-fluid d-block w-100 carousel-img" style="margin-bottom: 10px;">
                        ...
                        <div class="col-md-3">
                            <img src="/assets/learning 3.jpg" alt="Tenggat Waktu" class="img-fluid d-block w-100 carousel-img" style="margin-bottom: 10px;">
                        ...
                        <div class="col-md-3">
                            <img src="/assets/learning 4.jpg" alt="Pembelajaran Online" class="img-fluid d-block w-100 carousel-img" style="margin-bottom: 10px;">
        ...
        <div class="container text-center">
            ...
            <div class="price-box">
                ...
                <ul class="list text-left">
                    ...
                    <li><i class="fa fa-laptop"></i> Pembelajaran Online</li>
                </ul>
                <a href="/form" class="btn btn-primary daftar-btn">DAFTAR SEKARANG</a>
            </div>
        </div>
    </section>
